<?php
	...
	print "<select size=1 name=\"DB1\" onChange=\"setValue(this)\">$s</select>....Node1<br>";
	print "<select size=1 name=\"DB2\" onChange=\"resubmit(this)\">$s</select>....Node2<br>";
	print "<select size=1 name=\"DB3\">$s</select>....Node3<br>";
?>
